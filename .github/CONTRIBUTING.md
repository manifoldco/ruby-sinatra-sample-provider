...
- [Search our issue
  tracker](https://github.com/manifoldco/ruby-sinatra-sample-provider/issues/search&type=issues)
  for your problem, someone may have already reported it

# Opening a Pull Request

To contribute, [fork](https://help.github.com/articles/fork-a-repo/)
`ruby-sinatra-sample-provider`, commit your changes, and [open a pull
...
ruby-sinatra-sample-provider is released under the [BSD 3-Clause
License](../LICENSE.md).
...
agreement](https://cla-assistant.io/manifoldco/ruby-sinatra-sample-provider),
